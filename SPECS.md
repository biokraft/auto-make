...
| `specs/15-rag-agent.md`                              | A high-level sketch for a RAG agent to provide project-aware Q&A. |
...
| 9     | Project Init Agent          | - Implement the `ProjectInitAgent` with tools for scaffolding projects.<br>- Create a library of project templates (FastAPI, CLI, etc.).                                       | `specs/16-project-init-agent.md`                                                                            | TBD    |
| 10    | RAG Agent Implementation    | - Implement the `RAGAgent` with tools for indexing and querying.<br>- Integrate a local vector DB (e.g., LanceDB).<br>- Train the `ManagerAgent` to delegate knowledge-based questions. | `specs/15-rag-agent.md`                                                                                     | TBD    |
